  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='/hr/create-job' element={<CreateJobPosting></CreateJobPosting>}></Route>
        <Route path='/hr/companies-list' element={<Companies></Companies>}></Route>
        <Route path='/hr/message-container' element={<MessageContainer></MessageContainer>}></Route>
        ...
        <Route path='/student/profile' element={<ProfileSection></ProfileSection>}></Route>
        <Route path='/student/jobs' element={<JobSection></JobSection>}></Route>
        <Route path='/student/allprofiles' element={<AllProfileSection></AllProfileSection>}></Route>
        <Route path='/student/updates' element={<UpdateSection></UpdateSection>}></Route>
        <Route path='/student/messageHRD' element={<MessageHRDSection></MessageHRDSection>}></Route>
