...
const MessageFriend = (): JSX.Element => {
  ...
  const friendUSN: USNType = queryParams.get("frndUSN"); // USN of friend . Conversations of current student and friend with these USNs should be rendered on screen.
  ...
  const [conversations, setConversations] = useState<eachMessageType[]>([]); //array of previous messages
