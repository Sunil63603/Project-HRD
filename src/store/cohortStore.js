import { create } from "zustand"; //create function will [create a store,provide functions/actions to update state,automatically inform component about state change]
...
//step 1:create data.
const cohortStore = (set) => ({
  pollingInterval: 100000000, //this is used in all fetching operations
});
